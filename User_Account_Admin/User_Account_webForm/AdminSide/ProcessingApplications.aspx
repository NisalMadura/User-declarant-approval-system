...
<div class="button-container">    
            ...
            <asp:Button ID="btn_approvedApplication" runat="server" BackColor="#009900" BorderColor="#99CCFF" CssClass="auto-style52" OnClick="btn_approveapplications_Click" Text="Approved Applications"/>

            <asp:Button ID="btn_rejectedApplication" runat="server" BackColor="#990000" BorderColor="#99CCFF" CssClass="auto-style52" OnClick="btn_rejectedapplications_Click" Text="Rejected Applications" />

            <asp:Button ID="btn_processApplication" runat="server" BackColor="#990099" BorderColor="#99CCFF" CssClass="auto-style52 blinking-button" OnClick="btn_processingapplications_Click" Text="Processing Applications" OnClientClick="startBlinking();"  />

            <asp:Button ID="btn_userstatus" runat="server" BackColor="#6699FF" BorderColor="#99CCFF" CssClass="auto-style52 " OnClick="btn_userstatus_Click" Text="View Existing User Details"  />
