...
<body>
    <div class="auto-style25">
        <h1 style="font-family: Arial, Helvetica, sans-serif; color: #003366; text-decoration: blink; font-weight: bold; font-size: x-large;" class="auto-style37">
            <img alt="" class="auto-style28" src="../Uploadadmin/BOI1.png" style="text-align: left" />Application For The User Accounts</h1>
...
<div class="center">
        <table class="auto-style32">
            ...
            <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:db_useraccountConnectionString1 %>" SelectCommand="SELECT [UserName], [Email], [contact_no], [UserID], [VerificationStatus] FROM [tbl_user_details] WHERE ([DOCNO] = @DOCNO)" >
                <SelectParameters>
 ...
 <div class="auto-style36">
   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <br />
    <asp:Button ID="btn_deletePdf" runat="server" BackColor="#CC3300" BorderColor="#CC3300" CssClass="auto-style42" Font-Bold="True" Height="41px" OnClick="btn_deletePdf_Click" Text="Delete Current PDF" Width="169px" />
    <asp:Button ID="btn_resensLink" runat="server" BackColor="#3366FF" BorderColor="#3366FF" CssClass="auto-style43" Font-Bold="True" Height="40px" OnClick="btn_resensLink_Click" Text="Resend Link" Width="163px" />
    <br />
...
<img class="auto-style39" src="../Uploadadmin/comm.png" /><br />
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
