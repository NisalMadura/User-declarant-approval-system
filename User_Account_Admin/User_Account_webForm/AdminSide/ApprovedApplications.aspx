...
&nbsp;&nbsp; </h1>
        ...
        <asp:Button ID="btn_pendingApplication" runat="server" BackColor="#FF9900"  CssClass="auto-style52 " OnClick="btn_pendingapplications_Click" Text="Pending Applications"/>
            ...
            <asp:Button ID="btn_approvedApplication" runat="server" BackColor="#009900"  CssClass="auto-style52 blinking-button" OnClick="btn_approvedapplications_Click" Text="Approved Applications" OnClientClick="startBlinking();" Font-Bold="True" style="margin-left: 0px" />

            <asp:Button ID="btn_rejectedApplication" runat="server" BackColor="#990000" CssClass="auto-style52 " OnClick="btn_rejectapplications_Click" Text="Rejected Applications"/>

            <asp:Button ID="btn_processApplication" runat="server" BackColor="#990099"  CssClass="auto-style52 " OnClick="btn_processapplications_Click" Text="Processing Applications" />
