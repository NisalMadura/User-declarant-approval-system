...
&nbsp;&nbsp; 
    ...
    <asp:Button ID="btn_pendingApplication" runat="server" CssClass="auto-style52 blinking-button" BackColor="#FF9900" OnClick="btn_PendingApplications_Click" Text="Pending Applications" />
    <asp:Button ID="btn_approvedApplication" runat="server" CssClass="auto-style52" OnClick="btn_ApproveApplications_Click" BackColor="#009900" Text="Approved Applications" />
    <asp:Button ID="btn_rejectedApplication" runat="server" CssClass="auto-style52" OnClick="btn_RejectApplications_Click" BackColor="#990000" Text="Rejected Applications" />
    <asp:Button ID="btn_processApplication" runat="server" CssClass="auto-style52" OnClick="btn_ProcessingApplications_Click" BackColor="#990099" Text="Processing Applications" />
    <asp:Button ID="btn_userstatus" runat="server" CssClass="auto-style52" OnClick="btn_userstatus_Click" BackColor="#6699FF" Text="View Existing User Details" />
</div>

        <div class="auto-style31" style="font-family: Cambria; color: #003366; font-size: large; font-weight: bold">
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Label ID="lblSearch" runat="server" Text="Search Reference Number:" Font-Bold="True" Font-Names="Cambria"></asp:Label>
