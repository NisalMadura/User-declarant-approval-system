<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApprovedApplications.aspx.cs" Inherits="User_Account_webForm.ApprovedApplications" %>
...
&nbsp;
            <asp:Button ID="btn_approvedApplication" runat="server" BackColor="#009900" BorderColor="#99CCFF" CssClass="auto-style52 blinking-button" OnClick="btn_approvedapplications_Click" Text="Approved Applications" Width="185px" BorderStyle="None" Height="35px"  OnClientClick="startBlinking();" Font-Bold="True" style="margin-left: 0px" />
            ...
            <asp:Button ID="btn_processApplication" runat="server" BackColor="#990099" BorderColor="#99CCFF" CssClass="auto-style52 " OnClick="btn_processapplications_Click" Text="Processing Applications" Width="197px" BorderStyle="None" Height="35px" Font-Bold="True" style="margin-left: 6px" />
